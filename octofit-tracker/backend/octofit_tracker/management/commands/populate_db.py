...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Activity.objects.create(user=superman, type='Weightlifting', duration=50)

        # Create workouts
        Workout.objects.create(name='Super Strength', description='Strength training for heroes', suggested_for='Marvel')
        Workout.objects.create(name='Agility Boost', description='Agility training for DC heroes', suggested_for='DC')
